 ...
 * 2018-09-21T16:21:05.861+08:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "HL7MessageServerService",
                  wsdlLocation = "file:/Users/yfan/Project/fsie/components/chinese-hip-v1/src/main/java/com/fs/ie/components/chship/HIPMessageServer.wsdl",
...
public class HL7MessageServerService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/yfan/Project/fsie/components/chinese-hip-v1/src/main/java/com/fs/ie/components/chship/HIPMessageServer.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HL7MessageServerService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Users/yfan/Project/fsie/components/chinese-hip-v1/src/main/java/com/fs/ie/components/chship/HIPMessageServer.wsdl");
        }
        WSDL_LOCATION = url;
    }
